    ...
    public static void main(String args[]) throws FileNotFoundException
    {
        ...
        try (Scanner input = new Scanner(System.in)) {
			...
			while (status == 1)
			{
			    System.out.println("\n                                    MAIN MENU");
			    System.out.println("-----------------------------------------------------------------------------------");
			    System.out.println("1.Doctos  2. Patients  3.Medicines  4.Laboratories  5. Facilities  6. Staff 7. locations ");
			    System.out.println("-----------------------------------------------------------------------------------");
			    ...
			    switch (choice)
			    {
			        ...
			        case 7:
			        {
			        	Scanner sc = new Scanner(new File("C:\\Users\\abhim\\Desktop\\a1.csv")); 
			        	System.out.println("XCoord          YCoord FID       Name     ADDRESS      FACILITYID");
